...
plot(ridge_model,xvar="lambda",label=T,lwd=2)
...
beta_coeff = as.matrix(ridge_model$beta) # ridge coefficients
...
legend("topleft",legend=c("lcavol (1)","lweight (2)","age (3)","lbph (4)","svi (5)","lcp (6)","gleason (7)",
                           "pgg45 (8)"),pch=19,col=c("black","red","green","blue",
                                                            "brown","violet","aquamarine",
                                                            "orange"))
